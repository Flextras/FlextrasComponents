 ...
 *
 *  @eventType com.flextras.calendar.CalendarChangeEvent.NEXT_DAY
 */
[Event(name="nextDay", type="com.flextras.calendar.CalendarChangeEvent")]

/**
 *  This event is dispatched when the user clicks the button in the dayHeaderRenderer to get to the previous day.
 *
 *  @eventType com.flextras.calendar.CalendarChangeEvent.PREVIOUS_DAY
 */
[Event(name="previousDay", type="com.flextras.calendar.CalendarChangeEvent")]
